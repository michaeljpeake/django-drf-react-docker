...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # important position for CORS middleware
...
STATIC_ROOT = BASE_DIR / 'staticfiles'  # the magic that makes the admin styling appear with gunicorn
